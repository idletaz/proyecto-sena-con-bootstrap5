...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-03-2024 a las 11:11:27
...
(11, 12, '2024-03-28', '2024-03-31', 0.3, 7000);
...
INSERT INTO `tprodu` (`id_producto`, `nombre_producto`, `precio_producto`, `cantidad`, `descripcion`, `talla`, `categoria`, `ruta_img`, `estado`, `color`, `Ingreso_producto`, `fecha_mod`, `oferta`) VALUES
(2, 'Blusa Mara', 70000, 5, 'La Blusa Mara Blanca es una camisa elegante hecha de seda princesa, con cuello y mangas amplias. El puño delantero se adorna con botones forrados, lo que la hace ideal para anudar y crear un estilo de vanguardia. Disfruta de la calidad y comodidad que sólo la Blusa Mara Blanca te puede ofrecer.', 'S', 'Ropa', 'uploads/imagen_1711613609_8873.webp', 'activo', 'Negro', '2024-03-14 08:20:11', '2024-03-28 14:13:29', 0),
(4, 'Blusa Mara Verde Jade', 70000, 6, 'La Blusa Mara es una camisa elegante hecha de seda princesa, con cuello y mangas amplias. El puño delantero se adorna con botones forrados, lo que la hace ideal para anudar y crear un estilo de vanguardia. Disfruta de la calidad y comodidad que sólo la Blusa Mara Blanca te puede ofrecer.', 'S', 'Ropa', 'uploads/imagen_1711614865_1819.webp', 'activo', 'Verde', '2024-03-14 08:20:11', '2024-03-28 14:34:25', 0),
(5, 'Blusa Mara Morada', 70000, 7, 'La Blusa Mara es una camisa elegante hecha de seda princesa, con cuello y mangas amplias. El puño delantero se adorna con botones forrados, lo que la hace ideal para anudar y crear un estilo de vanguardia. Disfruta de la calidad y comodidad que sólo la Blusa Mara Blanca te puede ofrecer.', 'S', 'Ropa', 'uploads/imagen_1711614941_5278.webp', 'activo', 'Morado', '2024-03-14 08:20:11', '2024-03-28 14:35:41', 0),
(6, 'Blusa verde Formal', 15000, 3, 'Es una blusa para ocasiones formales', 'M', 'Blusa', 'uploads/blusa_verde.jpeg', 'activo', 'Verde', '2024-03-14 08:20:11', NULL, 1),
(7, 'Blusa ', 10000, 3, 'Una blusa verde para ocasiones especiales', 'M', 'Blusa', 'uploads/imagen_1709885609_3478.png', 'activo', 'Verde', '2024-03-14 08:20:11', NULL, 1),
(12, 'Bolso DGC', 10000, 2, 'Bolso Dolce y gabbanee', 'Sin_talla', 'Bolso', 'uploads/imagen_1709889991_7096.jpg', 'activo', 'Rojo', '2024-03-14 08:20:11', NULL, 1),
(13, 'Blusa verde', 3000, 3, 'asdas', 'M', 'Jean', 'uploads/imagen_1709964883_3702.png', 'activo', 'Verde', '2024-03-14 08:20:11', NULL, 0),
(15, 'Bolso Versace', 30000, 10, 'Bolso azul versace', 'Sin_talla', 'Bolso', 'uploads/imagen_1710233784_6351.jpg', 'activo', 'Azul', '2024-03-14 08:20:11', NULL, 0),
(17, 'Bolso', 20000, 5, 'Bolso azul versace', 'Sin_talla', 'Bolso', 'uploads/imagen_1710404599_4484.jpg', 'activo', 'Azul', '2024-03-14 14:23:19', NULL, 0),
(18, 'Zapato Paris', 120000, 6, 'Puntera abierta clásica y colores modernos. Altura del tacón: 4.5 pulgadas (aproximadamente, puede variar según el tamaño).', '36', 'Zapato', 'uploads/imagen_1711612289_5858.webp', 'activo', 'Azul', '2024-03-28 13:51:29', NULL, 0),
(19, 'Tacones Bautista', 200000, 6, 'Los zapatos de esta colección, hechos de material sintético, se ven coloridos y atrevidos, y están en tendencia, pero también tienen algo más en común: su comodidad.', '37', 'Zapato', 'uploads/imagen_1711612388_6194.webp', 'activo', 'Azul', '2024-03-28 13:53:08', NULL, 0);
...
(36, 'gjdiaz.2020@gmail.com', '$2y$10$pwqfMq1YwiXH6tHEzIXAzeoYjRRm983z9gh.mv.5X.IXc9SaXHRla', 'Gilberto', 'Diaz ', '12312', 'asd', 'adas', 3, 1, '2024-02-29 06:17:36', 1, '1231231'),
